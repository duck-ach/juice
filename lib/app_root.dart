...
/// 온보딩 단계를 언어 선택 → 통화 선택 → 목표 갈림길(단기/장기) → 대시보드 순으로 분기.
...
/// 갈림길 이후 단기/장기 화면은 GoalTypeChoiceStep이 Navigator.push로 직접 띄우며,
/// 완료 시 그 화면이 스스로 pop해 이 아래에서 이미 전환된 MainShell을 드러낸다.
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final child = !hasSelectedLanguage
        ...
        : !hasSelectedCurrency
            ...
            : (hasOnboarded ? const MainShell() : const GoalTypeChoiceStep());
