...
/// 카테고리/결제수단 상세 화면 공용: 최근 N개월(마지막 포인트=당월) 추이 막대 차트.
/// 당월 막대만 고유 색으로 강조하고 나머지 달은 옅은 톤으로 표시한다. 막대 탭 시 금액 툴팁.
class TrendBarChart extends ConsumerWidget {
  const TrendBarChart({super.key, required this.trend, required this.color});
